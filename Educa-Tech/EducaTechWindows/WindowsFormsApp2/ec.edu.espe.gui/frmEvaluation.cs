...
namespace WindowsFormsApp2
{
    public partial class frmEvaluation : Form
    {
        ...
        {
           if (RImage1.Image!=null&&RImage2.Image!=null&& RImage3.Image != null && RImage4.Image != null && RImage5.Image != null && RImage6.Image != null && RImage7.Image != null && RImage8.Image != null )
            {
                picHelpEvaluation.BackColor = Color.Tomato;
                CPlay verificar = new CPlay();
                verificar.play(RImage1, RImage2, RImage3, RImage4, RImage5, RImage6, RImage7, RImage8, VImage1, VImage2, VImage3, VImage4, VImage5, VImage6, VImage7, VImage8, picHelpEvaluation, picTryAgain, position);
                pictureBox1.Visible = true;
               
                Image1.AllowDrop = false;
                Image2.AllowDrop = false;
                Image3.AllowDrop = false;
                Image4.AllowDrop = false;
                Image5.AllowDrop = false;
                Image6.AllowDrop = false;
                Image7.AllowDrop = false;
                Image8.AllowDrop = false;
